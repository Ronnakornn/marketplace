...
- Code implementation: `builder-agent`, inheriting `5.6 Luna` with `high`
  reasoning from the active task.
- Test and verification: `tester-agent`, `gpt-5.6-terra` with `medium`
  reasoning.
- Tester reports defects; builder owns code fixes.

- [x] task-1: Add the localized storefront data foundation
...
- [x] task-2: Build the safe public storefront profile and identity surface
...
- [x] task-3: Complete the shop-scoped catalog and shared marketplace chrome
...
- [x] task-4: Add storefront reviews, policies, chat, and funnel tracking
...
- [x] task-5: Verify the complete storefront milestone
