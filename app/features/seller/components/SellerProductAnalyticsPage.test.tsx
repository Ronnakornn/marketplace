...
vi.mock("#/i18n/client", () => ({
  useTranslations: () => (key: string) => ({
    ...
    "seller.analytics.loadingProducts": "Loading product analytics...",
    "seller.analytics.emptyRange": "No product analytics were recorded for this date range.",
    "seller.analytics.emptyProducts": "No products found.",
    "seller.analytics.loadingDailyTrend": "Loading daily trend...",
    "seller.analytics.emptyDailyTrend": "No daily analytics available.",
    "seller.analytics.loadingSkus": "Loading SKUs...",
    "seller.analytics.emptySkus": "No SKU performance yet.",
    "seller.analytics.loadingLowPerformers": "Loading low performers...",
    "seller.analytics.emptyLowPerformers": "No low-performing products in this range.",
    "seller.analytics.trendViews": "{date} views",
    "seller.analytics.trendAddToCart": "{date} add to cart",
    "seller.analytics.trendOrders": "{date} orders",
    "seller.analytics.lowPerformerSummary": "{views} views / {conversion} conversion",
    "seller.analytics.tune": "Tune",
    "seller.analytics.skuSummary": "{units} units / {orders} orders",
    "seller.analytics.loadError": "Failed to load product analytics.",
    "common.retry": "Retry",
