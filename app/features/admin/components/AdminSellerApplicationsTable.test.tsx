...
vi.mock("#/i18n/client", () => ({
  ...
  useTranslations: () => (key: string) => {
    const labels: Record<string, string> = {
      ...
      "admin.ui.applicant": "Applicant",
      "admin.ui.shopProfile": "Shop profile",
      "admin.ui.kycPayout": "KYC & Payout",
      "admin.ui.pickupDocuments": "Pickup & Documents",
      "admin.ui.review": "Review",
      "admin.ui.approve": "Approve",
      "admin.ui.reject": "Reject",
      "admin.cancel": "Cancel",
