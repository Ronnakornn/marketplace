...
vi.mock("#/i18n/client", () => ({
  useTranslations: () => (key: string) => ({
    ...
    "buyer.becomeSeller": "Become a seller",
    "buyer.buyerShortcuts": "Buyer shortcuts",
    "buyer.buyerChat": "Buyer chat",
    "buyer.changePassword": "Change password",
    "buyer.emailUnverified": "Email unverified",
    "buyer.emailVerified": "Email verified",
    "buyer.myOrders": "My orders",
    "buyer.name": "Name",
    "buyer.noPhoneAdded": "No phone added",
    ...
    "buyer.manage": "Manage",
    "buyer.phoneCode": "Phone code",
    "buyer.phoneCodeSent": "Phone verification code sent.",
    "buyer.phoneLinkedVerified": "Phone linked and verified.",
    "buyer.phoneNotVerified": "Phone not verified",
    "buyer.phoneVerified": "Phone verified",
    "buyer.phoneVerificationHelp": "Phone changes require verification before linking.",
    "buyer.profileDetails": "Profile details",
    "buyer.profileUpdated": "Profile updated.",
    "buyer.sellerAccountActive": "Seller account active",
    "buyer.sellerActiveDescription": "{name} is active. Seller tools are available while buyer cart, orders, reviews, returns, and chat remain available.",
    "buyer.sellerApplicationStatus": "Seller application status",
    "buyer.sellerChat": "Seller chat",
    "buyer.sellerRejectedDescription": "Update your seller application and submit again.",
    "buyer.sellerSubmittedDescription": "Your seller application is waiting for admin review. Buyer shopping tools remain available.",
    "buyer.sendPhoneCode": "Send phone code",
    "buyer.sendingPhoneCode": "Sending...",
    "buyer.startSelling": "Start selling",
    "buyer.startSellingDescription": "Open a shop without changing your buyer account.",
    "buyer.verifying": "Verifying...",
    "buyer.verifyAndLink": "Verify and link",
    "buyer.viewSellerStatus": "View seller status",
